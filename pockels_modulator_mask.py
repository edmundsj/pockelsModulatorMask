...
cell.add(addCapacitorStructures(lib, width=[200,400],
            offset=[1300, die_length/2 - die_padding-1000], name="CAPS1"))
cell.add(addCapacitorStructures(lib, width=[200,400],
            offset=[1300, die_length/2 - die_padding -1500], name="CAPS2"))
cell.add(addCapacitorStructures(lib, width=[200,400],
            offset=[1300, die_length/2 - die_padding -1500], name="CAPS3", layer=1))
...
test_lines = [addTestLines(lib,
        offset=[-1700 + 300*i, die_length/2],
        width=x,
        name='LINES' + str(x),
        layer=0) \
